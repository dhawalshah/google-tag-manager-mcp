"""gtm_zone — Zones resource (create, get, list, update, remove, revert)."""
...
def gtm_zone(action: str, parent: str | None = None, path: str | None = None,
             config: dict | None = None, confirm: bool = False,
             params: dict | None = None) -> dict:
    """Manage GTM zones within a workspace. Same action set as gtm_tag
